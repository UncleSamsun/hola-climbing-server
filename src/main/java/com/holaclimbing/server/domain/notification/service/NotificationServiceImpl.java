...
import com.holaclimbing.server.domain.notification.event.NotificationRequestedEvent;
...
public class NotificationServiceImpl implements NotificationService {
     ...
     *
     * <p>실제 INSERT와 FCM 전송은 NotificationRequestedEvent 리스너가 커밋 이후 비동기로 처리한다.</p>
     */
